        ...
        <TableBody>
          {data?.data.map((q) => (
            <TableRow key={q.id} hover>
              <TableCell>
                <Link to={`/admin/quotations/${q.id}`}>{q.receiptId}</Link>
              </TableCell>
              <TableCell>{q.companyName}</TableCell>
              <TableCell>{q.contactName}</TableCell>
              <TableCell>{q.subject}</TableCell>
              <TableCell>
                <Chip size="small" label={STATUS_LABEL[q.status]} />
              </TableCell>
              <TableCell>{q.assignee?.name ?? '-'}</TableCell>
